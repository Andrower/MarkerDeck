...
The video branch packages `ffmpeg-windows/ffmpeg.exe` for offline H.264 MP4 export. The build command prepares FFmpeg automatically before running electron-builder.
